...
def do_it(session, cities_ids, cities_dict, waiting_time, max_random_waiting_time, donate_method):
    """
    Parameters
    ----------
    session : ikabot.web.session.Session
    ...
    while True:
        for cityId in cities_ids:
            ...
            if donate_method is 1:
                ...
                (wood_prod, good_prod, typeGood) = getProductionPerSecond(session, cityId)
                percentage = cities_dict[cityId]['percentage']
